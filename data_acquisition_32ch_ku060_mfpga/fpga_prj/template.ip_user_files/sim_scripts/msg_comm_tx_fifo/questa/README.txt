...
#
# Generated by export_simulation on Fri Apr 26 16:44:52 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './msg_comm_tx_fifo.sh' script.

./msg_comm_tx_fifo.sh -reset_run
...
./msg_comm_tx_fifo.sh -noclean_files

For more information on the script, please type './msg_comm_tx_fifo.sh -help'.
