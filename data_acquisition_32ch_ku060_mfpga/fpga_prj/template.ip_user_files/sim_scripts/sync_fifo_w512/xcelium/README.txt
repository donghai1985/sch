...
#
# Generated by export_simulation on Mon Apr 08 12:00:31 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './sync_fifo_w512.sh' script.

./sync_fifo_w512.sh -reset_run
...
./sync_fifo_w512.sh -noclean_files

For more information on the script, please type './sync_fifo_w512.sh -help'.
