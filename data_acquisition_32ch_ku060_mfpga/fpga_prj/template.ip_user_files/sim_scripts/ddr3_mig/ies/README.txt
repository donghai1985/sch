...
#
# Generated by export_simulation on Tue Aug 13 15:57:27 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './ddr3_mig.sh' script.

./ddr3_mig.sh -reset_run
...
./ddr3_mig.sh -noclean_files

For more information on the script, please type './ddr3_mig.sh -help'.
