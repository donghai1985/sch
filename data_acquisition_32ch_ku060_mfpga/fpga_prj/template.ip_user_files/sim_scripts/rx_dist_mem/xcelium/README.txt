...
#
# Generated by export_simulation on Mon Mar 18 09:46:14 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './rx_dist_mem.sh' script.

./rx_dist_mem.sh -reset_run
...
./rx_dist_mem.sh -noclean_files

For more information on the script, please type './rx_dist_mem.sh -help'.
