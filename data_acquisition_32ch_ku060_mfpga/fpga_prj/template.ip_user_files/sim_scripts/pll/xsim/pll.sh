...
#
# Generated by Vivado on Mon Apr 08 10:15:14 +0800 2024
...
# Script info
echo -e "pll.sh - Script generated by export_simulation (Vivado v2021.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pll xil_defaultlib.pll xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pll -key {Behavioral:sim_1:Functional:pll} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_b70e.protoinst" -log simulate.log
}
