...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"$ref_dir/../../../../template.gen/sources_1/ip/pll" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"$ref_dir/../../../../template.gen/sources_1/ip/pll" \
    "$ref_dir/../../../../template.gen/sources_1/ip/pll/pll_clk_wiz.v" \
    "$ref_dir/../../../../template.gen/sources_1/ip/pll/pll.v" \
  2>&1 | tee -a vlogan.log
