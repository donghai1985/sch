...
module up_axi #(
  ...
  output                            up_wreq,
  output  [(AXI_ADDRESS_WIDTH-1):0] up_waddr,
  output  [31:0]                    up_wdata,
  input                             up_wack,
  output                            up_rreq,
  output  [(AXI_ADDRESS_WIDTH-1):0] up_raddr,
  input   [31:0]                    up_rdata,
  input                             up_rack);
  ...
  reg                               up_wsel = 'd0;
  reg                               up_wreq_int = 'd0;
  reg     [(AXI_ADDRESS_WIDTH-1):0] up_waddr_int = 'd0;
  ...
  reg                               up_rsel = 'd0;
  reg                               up_rreq_int = 'd0;
  reg     [(AXI_ADDRESS_WIDTH-1):0] up_raddr_int = 'd0;
  ...
  always @(posedge up_clk) begin
    if (up_rstn == 1'b0) begin
      ...
      if (up_wsel == 1'b1) begin
        ...
        up_waddr_int <= up_axi_awaddr[(AXI_ADDRESS_WIDTH-1):0];
  ...
  always @(posedge up_clk) begin
    if (up_rstn == 1'b0) begin
      ...
      if (up_rsel == 1'b1) begin
        ...
        up_raddr_int <= up_axi_araddr[(AXI_ADDRESS_WIDTH-1):0];
      end
